...
if __name__=="__main__":
    ...
    # local_angle_pub = rospy.Publisher('mavros/setpoint_attitude/attitude ', PoseStamped, queue_size=10)
    local_vel_pub = rospy.Publisher('mavros/setpoint_velocity/cmd_vel', TwistStamped, queue_size=10)
    ...
    for i in range(100):
        ...
        # local_angle_pub.publish(command_angle)
        rate.sleep()
    ...
    while not rospy.is_shutdown():
        ...
        if ch20 == 1:
            ...
            # command_angle.pose.position.x = 0.2
            # command_angle.pose.position.y = 0
            # command_angle.pose.position.z = 0
            ...
            # command_angle.pose.position.x = 0
            # command_angle.pose.position.y = 0
            # command_angle.pose.position.z = 0
